...
//  xử lý sự kiện để hiển thị chi tiết
...
//     Name: ${item.name}
//     Price:${item.price}
//     DescribeL:${item.describe}
//   `;

// //tạo đối tượng URLSearchParams và thêm chi tiết sản phẩm làm tham số
//       let params = new URLSearchParams();
//       params.set("id", item.id);
//       params.set("brand", item.brand);
//       params.set("type", item.type);
//       params.set("segment", item.segment);
//       params.set("image", item.image);
//       params.set("name", item.name);
//       params.set("price", item.price);
//       params.set("describe", item.describe);


//       // chuyển hướng đến productDetail.html với các thông số chi tiết sản phẩm
//       window.location.assign("DanhSachSanPham.html?" + params.toString());
//     });
newItem.addEventListener("click", function () {
